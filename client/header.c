...
//Envoi des data dans le buffer sur la socket ouverte en sockfd
...
//Recevoir les data sur la socket
...
//Lecture des données de connexion et mis dans la struct request_connexion
...
//Envoi des données avec l'en-tête
...
//Attente du ACK et vérification sur sa validité
...
//Lecture des données avec l'en-tête
